 ...
 */
public class Image extends JPanel implements Status {
    ...
    public Image(SecSvc securityService) {
        super();
        ...
        cameraHeader.setFont(StyleSvc.HEADING_FONT);
        ...
        addPictureButton.addActionListener(e -> {
            ...
            try {
                ...
                java.awt.Image tmp = new ImageIcon(currentCameraImage).getImage();
                cameraLabel.setIcon(new ImageIcon(tmp.getScaledInstance(IMAGE_WIDTH, IMAGE_HEIGHT, java.awt.Image.SCALE_SMOOTH)));
