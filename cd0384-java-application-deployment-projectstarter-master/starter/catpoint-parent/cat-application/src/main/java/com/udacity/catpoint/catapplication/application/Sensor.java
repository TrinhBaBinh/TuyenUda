...
import com.udacity.catpoint.catapplication.data.SensorType;
...
public class Sensor extends JPanel {
    ...
    public Sensor(SecSvc securityService) {
        super();
        ...
        addNewSensorButton.addActionListener(e ->
                addSensor(new com.udacity.catpoint.catapplication.data.Sensor(newSensorNameField.getText(),
     ...
     */
    private void setSensorActivity(com.udacity.catpoint.catapplication.data.Sensor sensor, Boolean isActive) {
     ...
     */
    private void addSensor(com.udacity.catpoint.catapplication.data.Sensor sensor) {
     ...
     */
    private void removeSensor(com.udacity.catpoint.catapplication.data.Sensor sensor) {
